  ...
  return (
    <section className='quote-section bg-[#18191C] w-full h-[550px] flex  text-center border-b border-[#2E2F32] pt-8'>
      ...
      <blockquote className='text-center m-auto basis-[60%] text-[#f5f6fa]'>
        <p className={`relative text-[35px]  italic max-w-[750px] w-full after:content-['"'] after:text-[#f5f6fa] after:font-bold after:italic before:content-['"'] before:text-[#f5f6fa] before:font-bold before:italic`}>Everyone should learn how to program a computer, because it teaches you how to think.</p>
